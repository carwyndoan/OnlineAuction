...
INSERT into USER(user_id, email, password, name, enable, profile_verified, registration_verified, user_type) values (4, 'customer1@miu.edu', '$2a$12$Pdn2Mxp1c7loJguhLtfzp.RRSHREL8Sp.bsasHnQzCLt8TSJzqiE6', 'Seller 4', 1, 1, 1, 3);
...
insert into product(product_id, active, name, status, seller_id) values (1, 1, 'Seller_Product_1', 1, 1);
insert into product(product_id, active, name, status, seller_id) values (2, 1, 'Seller_Product_2', 1, 3);
insert into product(product_id, active, name, status, seller_id) values (3, 1, 'Seller_Product_3', 1, 4);
insert into product(product_id, active, name, status, seller_id) values (4, 1, 'Seller_Product_4', 1, 5);
insert into product(product_id, active, name, status, seller_id) values (5, 1, 'Seller_Product_5', 1, 5);
...
insert into category_product(product_id, category_id) values(1, 5);
...
insert into category_product(product_id, category_id) values(3, 4);
insert into category_product(product_id, category_id) values(3, 5);
insert into category_product(product_id, category_id) values(3, 6);

insert into category_product(product_id, category_id) values(4, 7);
